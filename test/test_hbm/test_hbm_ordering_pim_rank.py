# FIXME: this entire file is commented out because the HBM configs only use one rank...
...
#
#     t1 = mem.add_transaction_to_bank(0, 1, 0, 0, 0x0, False, True)
#     assert t1
#     t1 = mem.add_transaction_to_bank(0, 0, 0, 0, 0x0, False, True)
#     mem.tick()
#     t2 = mem.add_transaction_to_bank(0, 1, 0, 0, 0x0, True, True)
#     assert t2
...
#     mem.register_callbacks(log_cb, log_cb_w)
#
#     t1 = mem.add_transaction_to_bank(0, 1, 0, 0, 0x0, True, True)
#     assert t1
#     t1 = mem.add_transaction_to_bank(0, 0, 0, 0, 0x0, True, True)
#     mem.tick()
#     t2 = mem.add_transaction_to_bank(0, 1, 0, 0, 0x0, False, True)
#     assert t2
